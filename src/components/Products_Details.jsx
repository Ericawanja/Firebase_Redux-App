    ...
    <div className="p_detail_container">
      <div className="p_inner_wrapper">
        <span className="close_review_page">
          <Link onClick={() => setNavigating(!navigating)}> X </Link>
        ...
        <div className="item_details">
          ...
          <div className="item_detail">
            ...
            <span className="item_desc">{item[0].description}</span>
          </div>
        </div>
        ...
        <div className="item_reviews">
            ...
            <div className="review_form">
              <span className="review_form">
                <span className="review_input">
                  ...
                  {alert && (
                    <h3 style={{ color: "red" }}>
                      The stars should be less than five and the review should
                      not be empty
                    </h3>
                  )}
                </span>
          ...
          <div className="reviews_list">
            {item_reviews.length > 0 &&
              item_reviews.map((r, index) => {
                let { review, stars } = r;
                return (
